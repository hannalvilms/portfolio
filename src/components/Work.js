            ...
            <div className="work animation-element slide slide-left testimonial" id="work">
                <div className=" work-row row col-lg-10 col-md-10 col-sm-12">
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12">
                        <a href="https://aed.academy/avaleht" target="_blank">
                            <img src={Aed} alt="aed"/>
                            <p>2nd grade study material (WIP)</p>
                        </a>
                    </div>
                    <div className="col-lg-4 col-md-6 col-sm-13">
                        <a href="https://hannalvilms.github.io/whereIsTheSun" target="_blank">
                            <img src={Weather} alt="weather"/>
                            <p>Weather app made using ReactJS and Sass</p>
                        </a>
                    </div>
                    <div className="col-lg-4 col-md-6 col-sm-12">
